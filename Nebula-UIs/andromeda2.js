    ...
    if (data.similarity_weights) {
        ...
        for (var i = 0; i < data.similarity_weights.length; i++) {
            ...
            if (j === sliders.length) {
                ...
                temporarySliders.push(obj);
            }

            if (temporarySliders.length === data.similarity_weights.length) {
                sliders.length = 0;
                sliders = temporarySliders;
            }
            else {
                sliders.concat(temporarySliders);
            }
